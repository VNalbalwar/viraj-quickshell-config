...
PanelWindow {
    ...
    Rectangle {
        ...
        // Mac-style notch: flush at the top, rounded only at the bottom.
        topLeftRadius: 0
        topRightRadius: 0
        bottomLeftRadius: 28
        ...
        Item {
            ...
            Row {
                ...
                Rectangle {
                    ...
                    MouseArea {
                        anchors.fill: parent
                        onClicked: if (mediaPlayer && mediaPlayer.canGoPrevious) mediaPlayer.previous()
                    }
                }
                ...
                Rectangle {
                    ...
                    MouseArea {
                        anchors.fill: parent
                        onClicked: if (mediaPlayer && mediaPlayer.canTogglePlaying) mediaPlayer.togglePlaying()
                    }
                }
                ...
                Rectangle {
                    ...
                    MouseArea {
                        anchors.fill: parent
                        onClicked: if (mediaPlayer && mediaPlayer.canGoNext) mediaPlayer.next()
                    }
                }
            }
